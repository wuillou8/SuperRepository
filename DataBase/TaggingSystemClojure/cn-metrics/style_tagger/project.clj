(defproject style-tagger "0.1.0-SNAPSHOT"
  ...
  :ring {:handler style-tagger.handler/app
         :uberwar-name "style-tagger.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "style-tagger.jar"

  :main style-tagger.server
  ...
  :profiles {:dev {:repl-options {:init-ns style-tagger.repl
                                  :nrepl-middleware []}
                   ...
                   :cljsbuild {:builds {:app {:source-paths ["env/dev/cljs"]
                                              :compiler {:main "style-tagger.dev"
                                                         :source-map true}}
}
}}
