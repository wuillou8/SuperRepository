        ...
        if (alignedSize>alignedStart)
        {
          ...
          case FirstAligned:
            if(peels>1)
            {
              ...
              {
                A11 = ei_pload<LhsPacket>(&lhs1[j-1+LhsPacketSize]);
                ei_palign<1>(A01,A11);
                A12 = ei_pload<LhsPacket>(&lhs2[j-2+LhsPacketSize]);
                ei_palign<2>(A02,A12);
                A13 = ei_pload<LhsPacket>(&lhs3[j-3+LhsPacketSize]);
                ei_palign<3>(A03,A13);
                ...
                A01 = ei_pload<LhsPacket>(&lhs1[j-1+2*LhsPacketSize]);
                ei_palign<1>(A11,A01);
                T0  = pcj.pmadd(A02, ptmp2, T0);
                A02 = ei_pload<LhsPacket>(&lhs2[j-2+2*LhsPacketSize]);
                ei_palign<2>(A12,A02);
                T0  = pcj.pmadd(A03, ptmp3, T0);
                ei_pstore(&res[j],T0);
                A03 = ei_pload<LhsPacket>(&lhs3[j-3+2*LhsPacketSize]);
                ei_palign<3>(A13,A03);
