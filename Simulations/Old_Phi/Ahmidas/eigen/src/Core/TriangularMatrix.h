...
public:
  ...
  {
    ei_assert(!((Mode&UnitDiag) && (Mode&ZeroDiag)));
  }
...
public:
  ...
  template<typename Other> TriangularView&  operator+=(const Other& other)
  {
  ...
  /** \sa MatrixBase::operator*=() */
  TriangularView&  operator*=(const typename ei_traits<MatrixType>::Scalar& other)
  {
    return *this = m_matrix * other;
  }
  /** \sa MatrixBase::operator/=() */
