...
template<typename Packet> inline Packet
ei_pand(const Packet& a, const Packet& b)
{
  return a & b;
}
...
template<typename Packet> inline Packet
ei_por(const Packet& a, const Packet& b)
{
  return a | b;
}
...
template<typename Packet> inline Packet
ei_pxor(const Packet& a, const Packet& b)
{
  return a ^ b;
}
...
template<typename Packet> inline Packet
ei_pandnot(const Packet& a, const Packet& b)
{
  return a & (!b);
}
...
template<typename Packet> inline Packet
ei_pload(const typename ei_unpacket_traits<Packet>::type* from)
{
  return *from;
}
...
template<typename Packet> inline Packet
ei_ploadu(const typename ei_unpacket_traits<Packet>::type* from)
{
  return *from;
}
...
template<typename Packet> inline Packet
ei_ploaddup(const typename ei_unpacket_traits<Packet>::type* from)
{
  return *from;
}
...
template<typename Packet> inline Packet
ei_pset1(const typename ei_unpacket_traits<Packet>::type& a)
{
  return a;
}
...
template<typename Packet> EIGEN_DECLARE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS
Packet ei_psqrt(const Packet& a)
{
  return ei_sqrt(a);
}
