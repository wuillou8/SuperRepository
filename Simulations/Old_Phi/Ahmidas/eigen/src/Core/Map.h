...
/** \class Map
  ...
  * \sa Matrix::Map()
  */
template<typename PlainObjectType, int MapOptions, typename StrideType, typename PScalar >
struct ei_traits<Map<PlainObjectType, MapOptions, StrideType, PScalar> >
...
template<typename PlainObjectType, int MapOptions, typename StrideType, typename PScalar > class Map
  : public MapBase<Map<PlainObjectType, MapOptions, StrideType, PScalar>, PScalar >
{
public:

  typedef MapBase<Map, PScalar> Base;
