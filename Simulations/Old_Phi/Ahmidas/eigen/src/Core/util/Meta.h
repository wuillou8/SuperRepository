...
template<typename T> struct ei_is_arithmetic
{
  enum { ret = false };
};
template<> struct ei_is_arithmetic<float>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<double>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<long double>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<bool>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<char>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<signed char>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<unsigned char>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<signed short>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<unsigned short>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<signed int>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<unsigned int>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<signed long>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<unsigned long>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<signed long long>
{
  enum { ret = true };
};
template<> struct ei_is_arithmetic<unsigned long long>
{
  enum { ret = true };
};

template<typename T> struct ei_makeconst
{
  typedef const T type;
};
template<typename T> struct ei_makeconst<const T>
{
  typedef const T type;
};
template<typename T> struct ei_makeconst<T&>
{
  typedef const T& type;
};
template<typename T> struct ei_makeconst<const T&>
