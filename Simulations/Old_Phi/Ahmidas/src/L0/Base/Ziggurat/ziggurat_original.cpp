...
//  Parameters:
//
//    Output, double EFIX, an exponential variate.
//
{ 
  double x;
...
unsigned long int Base::Ziggurat::jsr_value ( )
...
//  Parameters:
//
//    Output, double NFIX, a normal variate.
//
{
...
void Base::Ziggurat::r4_exp_setup ( )
...
//
//    Global, double FE[256], WE[256], data needed by R4_EXP.
//
{
...
double Base::Ziggurat::r4_exp_value ( )

//****************************************************************************80
//
//  Purpose:
//
//    R4_EXP_VALUE returns an exponentially distributed double.
//
//  Discussion:
//
...
//  Parameters:
//
//    Output, double R4_EXP_VALUE, an exponentially distributed random value.
//
{
  return REXP;
}
...
void Base::Ziggurat::r4_nor_setup ( )
...
//
//    Global, double FN[128], WN[128], data needed by R4_NOR.
//
{
...
double Base::Ziggurat::r4_nor_value ( )

//****************************************************************************80
//
//  Purpose:
//
//    R4_NOR_VALUE returns a normally distributed double.
//
//  Discussion:
//
...
//  Parameters:
//
//    Output, double R4_NOR_VALUE, a normally distributed random value.
//
{
  return RNOR;
}
...
double Base::Ziggurat::r4_uni_value ( )

//****************************************************************************80
//
//  Purpose:
//
//    R4_UNI_VALUE returns a uniformly distributed double.
//
//  Discussion:
//
...
//  Parameters:
//
//    Output, double R4_UNI_VALUE, a uniformly distributed random value in
//    the range [0,1].
//
{
  double value;
...
unsigned long int Base::Ziggurat::shr3_value ( )
...
unsigned long int Base::Ziggurat::ul_uni_value ( )
...
void Base::Ziggurat::zigset ( unsigned long int jsrseed )
