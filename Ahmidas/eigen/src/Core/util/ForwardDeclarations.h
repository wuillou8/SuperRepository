...
template<typename MatrixType, int MapOptions=Unaligned, typename StrideType = Stride<0, 0>, typename PScalar = typename ei_traits<MatrixType>::Scalar const *> class Map;
