                         ...
                         typeof(g_Comput.model) |> println
                           ...
                           ismatch(r"^/plot/?", _) ?
                              begin
                                   ...
                                   plotPerf2(g_Comput.perfo.perfs,g_Comput.perfo.randoms,vec,g_Comput.perfo.modelNames) #__TH.Recommenders)
                         #plotPerf2(::Array{Array{Perfo,1},1}, ::Array{Array{T,1},1}, ::Array{Int64,1}, ::Array{String,1})
                         #plotPerf2(__perfs::Array{Vector{Perfo},1}, __randoms::Array{Vector{Float64},1}, __xaxis, __modellabel::Vector{String}, __plotlabel::String = "")
